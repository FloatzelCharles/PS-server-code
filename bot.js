...
var commands = {
    ...
    spam: function(target, room, user) {
    	if(!this.can('hotpatch'))  return;
    	  this.sendReply('Bot is Love. Bot is Life.');
    	  this.sendReply('Bot is Love. Bot is Life.');
    	  this.sendReply('Bot is Love. Bot is Life.');
    },
    ...
    whois: (function () {
        ...
        return function (target, room, user) {
            ...
            if (target === 'masterfloat') message = 'A good coder named Charles, becareful he\'s a dick.';
            if (target === config.userid()) message = 'That\'s me.';
            if (target === 'zarel') message = 'Pokemon Showdown Creator';
            if (target === 'omegagangsta') message = 'A nice guy named gerry, who has the cutest babeh evarrrr!';
            if (target === 'bloodyzelda') message = 'A nice, loyal person. Unknown name cause he\'s a thug';
    ...
    helix: (function () {
        ...
        var reply = [
            ...
            "1/10",
            "0/10",
            "It's not what you look like that counts, but who you are inside.",
            "There is no rating for you, that's how hot you are!",
            "There is no rating for you, you're just...ewww.",
            "Is there a shreck rating? If it did exist, that would be you."
        ];
