...
var commands = exports.commands = {
	...
	groups: function (target, room, user) {
		if (!this.canBroadcast()) return;
		this.sendReplyBox(
			"+ <b>Voice</b> - They can use broadcast commands such as !dt, !u and !groups.<br />" +
			"% <b>Driver</b> - They can warn, mute and lock users, they also can moderate tournaments<br />" +
			"@ <b>Moderator</b> - The above, and they can ban users, and start tournaments.<br />" +
			"&amp; <b>Leader</b> - The above, but they can promote and they have IP access.<br />" +
			"# <b>Room Owner</b> - They are leaders of the room and can almost totally control it<br />" +
			"~ <b>Administrator</b> - They have total access and control over the server."
		);
	},
